...
class CustomTrainer(L.LightningModule):
    ...
    def _step(self, batch, prex, batch_idx, log=True):
        ...
        if self.args.decode_rt:
            ...
            loss_total = loss_rot + loss_pm + loss_sz + loss_trans + loss_bind + loss_centroid + loss_z
            self.loss_dict = {
                'loss': loss_total,
        ...
        # total loss
        loss_total = loss_o + loss_pm + loss_rot + loss_trans + loss_bind + loss_centroid + loss_z + loss_sz
