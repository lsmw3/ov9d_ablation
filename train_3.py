...
def main():
    ...
    if args.dataset == "arkitscenes_3" or args.dataset == "multiscene_3":
    ...
    if args.dataset == "arkitscenes_3":
        ckpt_folder_name = "arkitscenes_3"
        if args.decode_rt:
            ckpt_folder_name = ckpt_folder_name + "-decode_rt"
    if args.dataset == "hypersim_3":
        ckpt_folder_name = "hypersim_3"
        if args.decode_rt:
            ckpt_folder_name = ckpt_folder_name + "-decode_rt"
    if args.dataset == "objectron_3":
        ckpt_folder_name = "objectron_3"
        if args.decode_rt:
            ckpt_folder_name = ckpt_folder_name + "-decode_rt"
    if args.dataset == "multiscene_3":
        ckpt_folder_name = "multiscene_3"
        if args.decode_rt:
            ckpt_folder_name = ckpt_folder_name + "-decode_rt"
