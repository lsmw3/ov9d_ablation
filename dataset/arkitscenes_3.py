...
class arkitscenes_3(BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        nocs_image = np.stack([cv2.resize(nocs_image_raw[..., i], (W, H), interpolation=cv2.INTER_LINEAR) for i in range(3)], axis=-1)
        ...
        # relative translation offset from the bbox centeroid to object centroid on 2d pixel planez
